...
public interface AttendanceRecordMapper extends BaseMapper<AttendanceRecord> {
    ...
    @Select({
            ...
            "         u.class_id, cl.class_name, cl.class_code ",
            ...
            "         u2.class_id, cl2.class_name, cl2.class_code ",
            "  FROM student_courses sc ",
            "  JOIN users u2 ON sc.student_id = u2.user_id AND u2.user_role = 0 ",
            "  LEFT JOIN classes cl2 ON u2.class_id = cl2.class_id ",
            ...
            "         u3.class_id, cl3.class_name, cl3.class_code ",
            "  FROM course_classes cc ",
            "  JOIN users u3 ON cc.class_id = u3.class_id AND u3.user_role = 0 ",
            "  LEFT JOIN classes cl3 ON u3.class_id = cl3.class_id ",
            ...
            "         u4.class_id, cl4.class_name, cl4.class_code ",
            "  FROM courses c_old ",
            "  JOIN users u4 ON c_old.class_id = u4.class_id AND u4.user_role = 0 ",
            "  LEFT JOIN classes cl4 ON u4.class_id = cl4.class_id ",
